...
- **Logo y diseño renovados** — nueva marca: una «N» formada por trazos con dos nodos enlazados (la esencia de un *nexo*: conectar personas) sobre degradado teal, aplicada en la app, el favicon y los iconos de la PWA; además pulido visual de la pantalla de acceso (marca con degradado y sombra), barra lateral, listas, foco accesible con anillo visible y micro-animaciones en botones y tarjetas.
